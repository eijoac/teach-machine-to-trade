...
class TradingEnv(gym.Env):
    ...
    def action_aug(self, action):
        ...
        sp = self.sp_rf_ts[0, cur_step]
        rf = self.sp_rf_ts[1, cur_step]
        sp_lag = self.sp_rf_ts[0, cur_step - self.lag : cur_step]
        rf_lag = self.sp_rf_ts[1, cur_step - self.lag : cur_step]
